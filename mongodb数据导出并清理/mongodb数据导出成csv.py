...
def run(mongodb_ip='192.168.1.45', db_name="shunqi", table_name="shunqi", start_rowkey_id=0):
    ...
    t1 = time.time()
    with open(table_name+".csv", mode='w', encoding="utf-8") as f_all_csv, open(table_name+"_bad被舍弃的数据.csv", mode='w', encoding="utf-8") as f_all_bad_csv:
...
if __name__ == "__main__":
    ...
    filepath_list = [r"D:\MLproject\工具脚本\mongodb爬虫数据导出\shunqi.csv", r"D:\MLproject\工具脚本\mongodb爬虫数据导出\tianyan.csv"]
    outfilepath = r"D:\MLproject\工具脚本\all_new.csv"
